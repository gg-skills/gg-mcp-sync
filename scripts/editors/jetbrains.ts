/**
 * @fileoverview MCP editor adapter for JetBrains IDEs; manages MCP server configuration for that standalone editor.
 *
...
export const jetbrainsAdapter: EditorAdapter = {
  id: "jetbrains",
  name: "JetBrains IDEs",
  type: "standalone",
  ...
  /**
   * Check if JetBrains is installed by looking for the config directory.
   */
