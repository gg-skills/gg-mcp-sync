/**
 * @fileoverview MCP editor adapter for Kilo Code; manages MCP server configuration for that VSCode extension.
 *
...
export const kiloCodeExtAdapter: EditorAdapter = {
  id: "kilo-code-ext",
  name: "Kilo Code (VSCode Ext)",
  type: "vscode-ext",
  ...
  /**
   * Check if Kilo Code VSCode extension is installed by looking for the global storage directory.
   */
